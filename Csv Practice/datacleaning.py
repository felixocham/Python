...
# no_transactions = len(daily_transactions)
# print(no_transactions)
for transaction in daily_transactions:
  transaction.split("_")
  daily_transactions_split.append(transaction.split("_"))
#pprint.pprint(daily_transactions_split, width = 120)

# cleaning the data and displaying on the consoke for verification
transactions_clean = []
...
for colour in thread_sold:
   if not "&" in colour:
     ...
     mult_colour = colour.split("&")
     for i in mult_colour:
...
# creating a list of all colours sold
colours = []
...
for colour in colours:
  print(f"{colour_count(colour)} threads of {colour} colour  were sold today")